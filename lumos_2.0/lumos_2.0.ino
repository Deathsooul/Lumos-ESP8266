//Arquivo:   lumos_2.0.ino
//Descricao: Acionamento de lampada remotamente usando MQTT
...
#define servidor_mqtt_usuario     "wbescro"  //Usuário
#define servidor_mqtt_senha       "louco10"  //Senha
#define mqtt_topico_sub           "esp8266/lampadaLab"    //Tópico para subscrever o comando a ser dado no pino declarado abaixo

//Declaração do pino que será utilizado e a memória alocada para armazenar o status deste pino na EEPROM
#define pino                      0                   //Pino que executara a acao dado no topico "esp8266/lampadaLab" e terá seu status informado no tópico "esp8266/pinstatus"
